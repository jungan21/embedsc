...
public class MDNSServiceRegistry extends AbstractServiceRegistry {

  public MDNSServiceRegistry(EventBus eventBus, ServiceRegistryConfig serviceRegistryConfig,
  ...
  protected ServiceRegistryClient createServiceRegistryClient() {
    return new MDNSServiceRegistryClientImpl(serviceRegistryConfig);
  }
}
